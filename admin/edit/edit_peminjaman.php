...
<div class="wrapper">
  ...
  <div class="modal" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              ?>
                <div class="modal-header">
                    <h4 class="modal-title" id="editModalLabel">Edit peminjaman</h4>
                    <a href="../peminjaman.php"><button type="button" class="close" aria-label="Close">
          ...
          <div class="form-grup">
            <label for="peminjaman">Nama peminjaman:</label>
            <input type="text" name="peminjaman" class="form-control" value="<?= $rew['id']?>">
        </div>
        </div>
                <div class="modal-footer">
                        <a href="../peminjaman.php"><button type="submit"  class="btn btn-primary">Simpan peminjaman</button></a>
                  </div>
                  </form>
                <?php 
                    }  
